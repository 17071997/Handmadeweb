        ...
        if (err){
            ...
            data.Items.forEach(function (clips) {
                htmlCode += "<div class=\"box\">\n" +
                    "            <img src=\""+clips.img+"\" width=\"395\" height=\"400\" style=\"margin-top: 5px;margin-left: 15px;\"/>\n" +
                    "            <hr/>" +
                    "            <span style=\"text-align: center;\">" +
                    "                <a href=\""+clips.urlVideo+"\" style=\"font-family: Georgia;font-size: 20px;text-decoration: none;color: black;text-align: center;\">"+clips.title+"</a>" +
                    "            </span>" +
                    "        </div>"
            });
